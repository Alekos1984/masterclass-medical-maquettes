...
export default async function FormateurDetailFormationPage({
  ...
  const data = {
    ...
    programme: formation.programme as { heureDebut: string; heureFin: string; titre: string; description: string; type: string }[],
    ...
    certifBlocCode: formation.certifBlocCode ?? null,
    certifActionTitre: formation.certifActionTitre ?? null,
  };
